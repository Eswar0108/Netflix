...
export async function getHomePageData() {
  ...
  const featured = trending[0] || topRated[0] || action[0] || comedy[0] || {
    ...
    overview: 'Set TMDB_API_KEY in your environment to load live data from TMDB. If TMDB is unavailable during build, the app now falls back safely instead of crashing the deployment.',
    releaseDate: '—',
    rating: 'N/A',
    backdropUrl: null,
    posterUrl: null,
